...
const events = [
  ...
  },
  {
    ...
    tagColor: '#60a5fa',
    description:
      'Acquire advanced skills in AutoCAD, Cloud Computing, 3D shader programming, and Machine Learning. Continuing to explore the intersection of technology and creativity.',
    photos: [
      { src: 'timeline/cert-proj-skill/cert-proj-skill-1.jpg', caption: 'AWS Cloud Practitioner Certificate' },
      { src: 'timeline/cert-proj-skill/cert-proj-skill-2.jpg', caption: 'Design sketches and concepts in AutoCAD for drafting housing models' },
      { src: 'timeline/cert-proj-skill/cert-proj-skill-3.jpg', caption: 'Apply Fundamental Principles of Cloud Architecture for a serverless application' },
      { src: 'timeline/cert-proj-skill/cert-proj-skill-4.jpg', caption: 'Deploy AWS Rekognition Image Analyzer ' },
      { src: 'timeline/cert-proj-skill/cert-proj-skill-5.jpg', caption: '3D Shader Project' },
      { src: 'timeline/cert-proj-skill/cert-proj-skill-6.jpg', caption: 'Outtakes' },
    ],
  },
  {
    year: '2026',
  ...
  },
  {
    ...
    tagColor: '#4ade80',
    description:
      'Continuing to design and build physical game prototypes, in Unity, and Unreal. Exploring narrative design, procedural generation, multiplayer tracking & systems.',
    photos: [
      { src: 'timeline/games/gorrila/gorilla-getaway-1.jpg', caption: '1st Successful Board Game, Gorrila Getaway' },
      { src: 'timeline/games/gorrila/gorilla-getaway-2.jpg', caption: 'Gorrila Getaway Presentation, praised by veteran game designer, Richard Lemarchand' },
      { src: 'timeline/games/rilvaryclash/rivalry-clash.jpg', caption: '2D RTS Game: Rivalry Clash, inspired by classic strategy games like Clash Royale' },
      { src: 'timeline/games/orderup/order-up.jpg', caption: '2D Cooking Game: Order Up!, inspired by classic mobile cooking games' },
      { src: 'timeline/games/orderup/order-up-presentation.jpg', caption: 'Order Up Presentation' },
      { src: 'timeline/games/BLUE/blueheavenly-aerospace.jpg', caption: 'BlueHeavenly Aerospace, AGP indie game project by USC, available on Steam' },
      { src: 'timeline/games/outtakes.jpg', caption: 'Outtakes' },
    ],
  },
];
